...
from src.componenets.model_trainer import ModelTraier, ModelTrainerConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv('/Users/harshithreddy/Desktop/AdvanceMachineLearning/End-EndML/data/stud.csv')
